...
void bindings_decpomdp(py::module& m) {
    ...
    py::class_<synthesis::DecPomdp>(m, "DecPomdp", "dec-POMDP")
        ...
        .def("set_observation_memory_size", &synthesis::DecPomdp::setObservationMemorySize, "Set memory size to a selected observation.", py::arg("observation"), py::arg("memory_size_list"))
        .def("set_global_memory_size", &synthesis::DecPomdp::setGlobalMemorySize, py::arg("memory_size"))
        .def_property_readonly("joint_observation_memory_size", [](synthesis::DecPomdp& decpomdp) {return decpomdp.joint_observation_memory_size;})
