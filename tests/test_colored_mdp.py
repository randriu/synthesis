...
class TestColoredMdp:
    ...
    def test_representation_only_surface(self, colored_mdp):
        ...
        '''
        removed = [
            "empty_scheduler", "discard_unreachable_choices", "scheduler_to_state_to_choice",
            "state_to_choice_to_choices", "choice_values", "compute_expected_visits",
            "make_vector_defined", "holes_with_max_score", "parameters_with_max_score",
            "estimate_scheduler_difference", "identify_target_states", "restrict",
        ]
