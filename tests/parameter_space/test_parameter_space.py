...
class TestParameterSpaceRepresentationOnlySurface:
    ...
    def test_fresh_parameter_space_carries_no_search_state(self):
        ...
        removed_or_never_present = [
            "mdp", "selected_choices", "analysis_result", "encoding",
            "parent_info", "refinement_depth", "constraint_indices",
            "candidate_policy", "scheduler_choices",
            "add_parent_info", "collect_parent_info", "encode",
        ]
