...
options = [
    click.option("--tree-depth", default=0, type=int, panel=_PANEL,
        help="decision tree synthesis: tree depth"),
    click.option("--tree-enumeration", is_flag=True, default=False, panel=_PANEL,
        help="decision tree synthesis: if set, all trees of size at most tree_depth will be enumerated"),
    click.option("--tree-map-scheduler", type=click.Path(), default=None, panel=_PANEL,
        help="decision tree synthesis: path to a scheduler to be mapped to a decision tree"),
    click.option("--add-dont-care-action", is_flag=True, default=True, panel=_PANEL,
