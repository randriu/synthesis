    ...
    namespace settings {
        namespace modules {
            ...
            NativeEquationSolverSettings::NativeEquationSolverSettings() : ModuleSettings(moduleName) {
                std::vector<std::string> methods = { "jacobi", "gaussseidel", "sor", "walkerchae", "power", "sound-value-iteration", "svi", "optimistic-value-itearation", "ovi", "interval-iteration", "ii", "ratsearch", "cudajacobi" };
            ...
            storm::solver::NativeLinearEquationSolverMethod NativeEquationSolverSettings::getLinearEquationSystemMethod() const {
                ...
                } else if (linearEquationSystemTechniqueAsString == "cudajacobi") {
                    return storm::solver::NativeLinearEquationSolverMethod::CudaJacobi;
		}
