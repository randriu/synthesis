...
namespace storm {
    namespace solver {
        ...
        bool __valueIteration_solver_minimize(uint_fast64_t const, double const, bool const, std::vector<uint_fast64_t> const&, std::vector<uint_fast64_t> const&, std::vector<ValueType> const&, std::vector<ValueType>& x, std::vector<ValueType> const&, std::vector<uint_fast64_t> const&, size_t&) {
            //
...
#ifdef STORM_HAVE_CUDASYNTHESIS
            return valueIteration_solver_uint64_double_minimize(maxIterationCount, precision, relativePrecisionCheck, matrixRowIndices, columnIndices, nnzValues, x, b, nondeterministicChoiceIndices, iterationCount);
#else
...
#ifdef STORM_HAVE_CUDASYNTHESIS
            return valueIteration_solver_uint64_float_minimize(maxIterationCount, precision, relativePrecisionCheck, matrixRowIndices, columnIndices, nnzValues, x, b, nondeterministicChoiceIndices, iterationCount);
#else
            STORM_LOG_THROW(false, storm::exceptions::NotSupportedException, "Storm is compiled without CUDA support.");
#endif
        }
         ...
         */
        template <typename IndexType, typename ValueType>
        bool __valueIteration_solver_maximize(uint_fast64_t const, double const, bool const, std::vector<uint_fast64_t> const&, std::vector<uint_fast64_t> const&, std::vector<ValueType> const& , std::vector<ValueType>&, std::vector<ValueType> const&, std::vector<uint_fast64_t> const&, size_t&) {
            STORM_LOG_THROW(false, storm::exceptions::NotImplementedException, "Unsupported template arguments.");
        }
        template <>
...
#ifdef STORM_HAVE_CUDASYNTHESIS
            return valueIteration_solver_uint64_double_maximize(maxIterationCount, precision, relativePrecisionCheck, matrixRowIndices, columnIndices, nnzValues, x, b, nondeterministicChoiceIndices, iterationCount);
#else
            STORM_LOG_THROW(false, storm::exceptions::NotSupportedException, "Storm is compiled without CUDA support.");
#endif
        }
...
#ifdef STORM_HAVE_CUDASYNTHESIS
            return valueIteration_solver_uint64_float_maximize(maxIterationCount, precision, relativePrecisionCheck, matrixRowIndices, columnIndices, nnzValues, x, b, nondeterministicChoiceIndices, iterationCount);
#else
            STORM_LOG_THROW(false, storm::exceptions::NotSupportedException, "Storm is compiled without CUDA support.");
#endif
        }
