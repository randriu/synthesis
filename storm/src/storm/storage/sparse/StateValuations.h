        ...
        namespace sparse {
            ...
            public:
                ...
                public:
                    ...
                    friend class StateValuationLess; //+
                ...
                //+
                class StateValuationLess {
                public:
                    bool operator()(StateValuation const& a, StateValuation const& b) const {
                        return a.booleanValues < b.booleanValues || a.integerValues < b.integerValues || a.rationalValues < b.rationalValues;    
                    }
                };
                //.                
